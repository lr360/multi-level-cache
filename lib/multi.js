...
let MultiCache = (function () {
  ...
  function MultiCache(localCache, remoteCache, localCacheInvalidation, options) {
    ...
    this.useRemoteCacheDefault = this.options.hasOwnProperty('useRemoteCache') ?
      ...
      : true;
    this.useLocalCacheInvalidationDefault = this.options.hasOwnProperty('useLocalCacheInvalidation') ?
      this.options.useLocalCacheInvalidation
      : true;
    ...
    this.remoteCache = typeof remoteCache === 'string' ?
      ...
      : remoteCache;
    this.localCacheInvalidation = typeof localCacheInvalidation === 'string' ?
      createLocalCacheInvalidation(localCacheInvalidation, this.options.localCacheInvalidationOptions, this.localCache)
