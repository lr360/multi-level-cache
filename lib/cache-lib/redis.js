...
function getCacheInterface(client, errorState, defaultMinTtl, defaultMaxTtl) {
  function getError() {
...
module.exports = function(options) {
  let defaultMinTtl = options === undefined ? 3600 : options.ttl_min || 3600;
  let defaultMaxTtl = options === undefined ? 7200 : options.ttl_max || 7200;
  ...
  return getCacheInterface(client, errorState, defaultMinTtl, defaultMaxTtl);
};
